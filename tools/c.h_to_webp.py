...
parser = argparse.ArgumentParser(
    description="Convert C header array to WebP binary file"
)
parser.add_argument(
    "input_file", help="Path to the input C file containing the hex array"
)
parser.add_argument(
    "-o",
    "--output",
    default="output.webp",
    help="Path to the output WebP file (default: output.webp)",
)
